...
const CalculatorTemplateList = ({setElementId}: CalculatorComponentsProps) => {
  ...
  return (
    <div className='calculator-components' onDragStart={onDragHandler}>
      {calculatorDisplayMode === CalculatorMode.Edit &&
        <>
          <WrapperCalculatorComponentInTemplateList disabled={draggedElements.includes(CalculatorElementsName.Display)} id={CalculatorElementsName.Display} children={<Display/>}/>
          <WrapperCalculatorComponentInTemplateList disabled={draggedElements.includes(CalculatorElementsName.Operators)} id={CalculatorElementsName.Operators} children={<OperatorButtons/>}/>
          <WrapperCalculatorComponentInTemplateList disabled={draggedElements.includes(CalculatorElementsName.Numbers)} id={CalculatorElementsName.Numbers} children={<NumberButtons/>}/>
          <WrapperCalculatorComponentInTemplateList disabled={draggedElements.includes(CalculatorElementsName.Equal)} id={CalculatorElementsName.Equal} children={<EqualButton/>}/>
        </>}
    </div>
  );
};
