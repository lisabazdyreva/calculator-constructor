...
import {
  setFirstOperand,
  setSecondOperand,
} from "../../../store/calculations/calculations";
...
const NumberButtons = () => {
  ...
  const dispatchOperands = useCallback(
    (value: number | string) => {
  ...
  return (
    <div className="number-buttons" onClick={onButtonClickHandler}>
      ...
      <button className="number-buttons__item" type="button" value={"."}>
        ,
      </button>
      <button className="number-buttons__item" type="button" value={1}>
        1
      </button>
      <button className="number-buttons__item" type="button" value={2}>
        2
      </button>
      <button className="number-buttons__item" type="button" value={3}>
        3
      </button>
      <button className="number-buttons__item" type="button" value={4}>
        4
      </button>
      <button className="number-buttons__item" type="button" value={5}>
        5
      </button>
      <button className="number-buttons__item" type="button" value={6}>
        6
      </button>
      <button className="number-buttons__item" type="button" value={7}>
        7
      </button>
      <button className="number-buttons__item" type="button" value={8}>
        8
      </button>
      <button className="number-buttons__item" type="button" value={9}>
        9
      </button>
    </div>
  );
