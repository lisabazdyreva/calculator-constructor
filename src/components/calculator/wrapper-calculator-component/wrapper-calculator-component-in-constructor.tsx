...
import { removeElement } from "../../../store/calculator-construction/calculator-construction";
...
const WrapperCalculatorComponentInConstructor = ({
  children,
  order,
  id,
}: DragInsideWrapperProps) => {
  ...
  return (
    <div
      className={`component-wrapper calculator-components__wrapper ${
        id === CalculatorElementsName.Display ? "pointer-events-disable" : ""
      }`}
      draggable={
