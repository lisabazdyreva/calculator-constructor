    ...
    return (
        <div className="switcher main__switcher">
            <div className="switcher__buttons">
                ...
                <input onChange={onChangeDisplayModeHandler} className="switcher__input visually-hidden" id="display-active" name="display-mode" type="radio"
                ...
                <input onChange={onChangeDisplayModeHandler} className="switcher__input visually-hidden" id="display-edit" name="display-mode" type="radio"
