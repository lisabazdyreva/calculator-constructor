...
const SwitchButton = ({onChangeDisplayModeHandler, data}: ISwitchButton) => {
  ...
  return (
    <>
      <input onChange={onChangeInputHandler} className="switcher__input visually-hidden" id={id} name={`${data.mode}-mode`} type="radio" data-value={data.mode} checked={calculatorMode === data.mode}/>
